...
Modification : 
- to open in VS, right click on the dir --> open with VS
- looking recursively in the directory chosen by the user
- Do not ask for a output dir
- Do not ask for a filename
- Do not ask for imput dir. Looks in rp/
